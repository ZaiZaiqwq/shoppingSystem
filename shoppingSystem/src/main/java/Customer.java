...
public class Customer extends User{
    ...
    public void registration(){
        ...
        //获取用户输入的用户名并判断是否不少于5个字符
        System.out.print("username(No less than 5 characters): ");
        UserName = scanner.nextLine();
        ...
        //获取用户输入的密码并判断是否大于8个字符，是否是大小写字母，数字和标点符号的组合
        System.out.print("password(More than 8 characters and contain uppercase letters, lowercase letters, numbers and punctuation): ");
